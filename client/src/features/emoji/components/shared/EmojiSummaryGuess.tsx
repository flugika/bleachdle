...
/**
 * 🧩 Emoji's endgame summary — same tier-badge / accordion-history frame as
 * QuoteSummaryGuess. The "target reveal" block reuses <EmojiTestimonyDisplay>
 * (the Central 46 confidential-symbol dossier already used on the question
 * screen) so unsolved and solved states are visibly the same document — just
 * re-stamped with every emoji unsealed.
 */
            ...
            <div className={`w-full p-6 backdrop-blur-md relative overflow-hidden transition-all duration-500 border ${cardBgStyle}`}>
                ...
                <div className="text-center mb-6 relative z-10">
                    ...
                    <p className="text-[11px] tracking-[0.3em] uppercase text-[#ebc7c7]/50 mt-1">
                        {isWin ? "Symbol Set Traced to Registered Soul" : "Symbol Set Left Unattributed"}
                    </p>
                </div>
