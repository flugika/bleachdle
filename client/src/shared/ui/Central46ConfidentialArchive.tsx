...
const MODE_SPECIFIC_METHODS: Record<SubFeatureKey, string> = {
    ...
    image: "SHIKAKU VISUAL RECONSTRUCTION",
...
function CTAButton({ canReset, onClick }: { canReset: boolean; onClick: () => void }) {
    ...
    // ══ SOLID VISUAL MATRIX (ถมสีทึบเพื่อความเด่นสูงสุด) ══
    const bgColor = !canReset 
        ? "transparent" 
        : hovered 
            ? "#dec085" // สีทองสว่างวาบขึ้นเมื่อเอาเมาส์ไปชี้ (Hover)
            : T.gold;   // สีทองทึบแท้สไตล์ Central 46 เด่นทะลุจอแน่นอนเมื่อกดได้
    ...
    // ทำการกลับสีอักษร (Invert) เป็นสีเข้มเพื่อให้ Contrast สูงและอ่านง่ายที่สุดบนพื้นหลังสีทอง
    ...
    return (
        <button
            ...
            style={{
                ...
                opacity: canReset ? 1 : 0.3, // ถ้ากดไม่ได้ให้จมหายไปเลย แต่ถ้ากดได้จะสว่าง 100%
                display: "flex",
                alignItems: "flex-start",
                justifyContent: "space-between",
                // เพิ่ม Effect แสงเรืองรอง (Glow Shadow) รอบตัวปุ่มตอน hover เพื่อความพรีเมียม
        ...
        >
            <div style={{ textAlign: "left" }}>
                <p style={{
                    ...
                    textTransform: "uppercase",
                    color: mainTextColor,
                    fontWeight: canReset ? 700 : 400, // หนาแน่นขึ้นเมื่อพร้อมทำลายล้าง
                    margin: "0 0 7px",
        ...
        <div style={{ width: "100%", display: "flex", justifyContent: "center", padding: "40px 18px 0", userSelect: "none" }}>
            <div
                ...
                style={{
                    ...
                    color: T.body,
                    overflow: "hidden",
                    boxShadow: `0 0 0 1px ${T.border}, 0 410px 98px rgba(0,0,0,0.95)`,
                }}
            >
                {/* Watermark */}
                ...
                {/* ══ HEADER ══ */}
                <div style={{ padding: "210px 38px 0", position: "relative", zIndex: 10 }}>
                    <p style={{ fontSize: "11px", letterSpacing: "0.48em", color: T.muted, textTransform: "uppercase", margin: "0 0 110px" }}>
                    ...
                    <p style={{ fontSize: "14px", letterSpacing: "0.36em", color: T.mutedMid, textTransform: "uppercase", margin: "0 0 26px" }}>
                        CONFIDENTIAL ARCHIVES
                    </p>

                    <Rule />
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", padding: "14px 0" }}>
                        <div>
                            <p style={{ fontSize: "11px", letterSpacing: "0.3em", color: T.label, textTransform: "uppercase", margin: "0 0 7px" }}>CLASSIFICATION</p>
                            <p style={{ fontSize: "14px", letterSpacing: "0.18em", color: T.gold, margin: 0 }}>████ LEVEL BLACK</p>
                        </div>
                        <div>
                            <p style={{ fontSize: "11px", letterSpacing: "0.3em", color: T.label, textTransform: "uppercase", margin: "0 0 7px" }}>AUTHORIZATION</p>
                            <p style={{ fontSize: "14px", letterSpacing: "0.18em", color: T.gold, margin: 0 }}>LEVEL BLACK</p>
                        </div>
                    </div>
                    <Rule />
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", padding: "14px 0" }}>
                        <div>
                            <p style={{ fontSize: "11px", letterSpacing: "0.3em", color: T.label, textTransform: "uppercase", margin: "0 0 7px" }}>FILE NO.</p>
                            <p style={{ fontSize: "14px", letterSpacing: "0.12em", color: T.value, margin: 0 }}>{fileNo}</p>
                        </div>
                        <div>
                            <p style={{ fontSize: "11px", letterSpacing: "0.3em", color: T.label, textTransform: "uppercase", margin: "0 0 7px" }}>STATUS</p>
                            <p style={{ fontSize: "14px", letterSpacing: "0.2em", color: T.green, margin: 0 }}>APPROVED</p>
                        </div>
                    </div>
                    <Rule />
                ...
                {/* ══ QUOTE ══ */}
                <div style={{ padding: "26px 38px", position: "relative", zIndex: 10 }}>
                    <p style={{ fontSize: "15px", fontStyle: "italic", color: T.body, lineHeight: 1.8, letterSpacing: "0.05em", margin: "0 0 14px" }}>
                        Observation never ceases.<br />
                        Judgment merely awaits.
                    </p>
                    <p style={{ fontSize: "11px", color: T.muted, letterSpacing: "0.3em", textTransform: "uppercase", margin: 0 }}>
                ...
                <div style={{ padding: "26px 38px 0", position: "relative", zIndex: 10 }}>
                    <SectionHead>§ 01 — Subject Identification</SectionHead>

                    {!soulName ? (
                        <div>
                            <p style={{ fontSize: "14px", letterSpacing: "0.24em", color: T.value, textTransform: "uppercase", margin: "0 0 10px" }}>
                                IDENTITY REGISTRATION REQUIRED
                            </p>
                            <p style={{ fontSize: "15px", color: T.body, lineHeight: 1.75, letterSpacing: "0.04em", margin: "0 0 24px" }}>
                            ...
                            <p style={{ fontSize: "11px", color: T.muted, letterSpacing: "0.22em", textTransform: "uppercase", margin: "10px 0 0" }}>
                                Identity will be permanently inscribed in the Soul Registry
                            </p>
                        </div>
                    ) : (
                        <div>
                            <p style={{ fontSize: "14px", letterSpacing: "0.36em", color: T.mutedMid, textTransform: "uppercase", margin: "0 0 18px" }}>
                                PERSONAL DOSSIER
                            </p>
                            <Rule />
                ...
                <div style={{ padding: "210px 38px 0", position: "relative", zIndex: 10 }}>
                    ...
                    <div style={{ padding: "18px 0 14px" }}>
                        <p style={{ fontSize: "14px", letterSpacing: "0.36em", color: T.label, textTransform: "uppercase", margin: "0 0 10px" }}>
                            RESULT
                        </p>
                        <p style={{ fontSize: "26px", fontWeight: 700, letterSpacing: "0.16em", color: T.gold, textTransform: "uppercase", margin: "0 0 6px" }}>
                ...
                <div style={{ padding: "210px 38px 0", position: "relative", zIndex: 10 }}>
                    ...
                    {/* ── NOTICE BLOCK ── */}
                    <div style={{ borderLeft: "4px solid rgba(200,80,80,0.4)", paddingLeft: "18px", marginBottom: "26px" }}>
                        <p style={{ fontSize: "14px", letterSpacing: "0.3em", color: T.redNotice, textTransform: "uppercase", margin: "0 0 14px" }}>
                            NOTICE
                        </p>

                        <p style={{ fontSize: "14px", color: T.noticeTxt, lineHeight: 1.75, letterSpacing: "0.04em", margin: "0 0 6px" }}>
                            Initiating a new archive cycle will erase all active investigation records.
                        </p>

                        <p style={{ fontSize: "14px", color: T.noticeTxt, lineHeight: 1.75, letterSpacing: "0.04em", margin: "0 0 14px" }}>
                            <span style={{ color: T.redNotice, fontWeight: 600 }}>CURRENT STREAK</span>
                            {" "}will be reset to{" "}
                            <span style={{ color: T.redNotice, fontWeight: 600 }}>0</span>.
                        </p>

                        <p style={{ fontSize: "14px", color: T.noticeAlt, lineHeight: 1.75, letterSpacing: "0.04em", margin: "0 0 6px" }}>
                        ...
                        <p style={{ fontSize: "14px", color: T.noticeAlt, lineHeight: 1.75, letterSpacing: "0.04em", margin: 0 }}>
                ...
                {/* ══ FOOTER ══ */}
                <div style={{ borderTop: `1px solid ${T.borderDim}`, padding: "18px 38px", position: "relative", zIndex: 10, marginTop: "34px" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
                        ...
                        <p style={{ fontSize: "10px", color: T.muted, letterSpacing: "0.2em", textTransform: "uppercase", margin: 0 }}>
                            HASH C46-83A91F72
                        </p>
                    </div>
                    <p style={{ fontSize: "10px", color: T.borderDim, letterSpacing: "0.22em", textTransform: "uppercase", margin: 0 }}>
